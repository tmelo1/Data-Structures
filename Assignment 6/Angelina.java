...
public final class Angelina {
    ...
    private static void solveJolie() {
        ...
        ArrayList<Vertex<V>> breadthFirstList = new ArrayList<Vertex<V>>(graph.vertices().size());
        boolean[] wasVisited = new boolean[graph.vertices().size()];
        LinkedList<Vertex<V>> q = new LinkedList<Vertex<V>>();
